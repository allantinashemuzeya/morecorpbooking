    ...
    <div class="wrapper flex_box">
      <form @submit.prevent="createBooking">
        ...
        <div class="input">
          ...
          <input class="name" required v-model="formData.topic" placeholder="The topic of of your booking...?" type="text">
        </div>
        <div class="input">
          <label>
            Reason
          </label>
          <textarea required v-model="formData.reason" placeholder="Enter whatever you feel like..." class="comment"></textarea>
        </div>
        <div class="input">
          <label>
            Date & Time
          </label>
          <input type="datetime-local"  v-model="formData.start_time" class="date" required/>
        </div>
...
let saveStatus = ref("")
let authToken = await getAuthToken().access_token
...
function createBooking(){
  useStore().createBooking('setBookings', formData)
...
async function setStatus(){
  ...
  const { saveStatusMsg } =  useStore()

  saveStatusMsg('You have Successfully Created A Booking!')
